...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        courses = [
            ...
            ("ENT206", "Customer Relationship Management", level200, second_semester),
            ...
            ("CRP313", "Permanent Crop Production", level300, first_semester),
            ...
            ("SLM310", "Watershed Hydrology", level300, second_semester),
            ("SLM306", "Soil Erosion and Conservation", level300, second_semester),
            ("SLM305", "Introduction to Soil Chemistry, Fertility and Microbiology", level300, second_semester),
            ...
            ("ARD401", "Extension Practices", level400, second_semester),
        ]
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully seeded {len(courses)} Soil Science courses."
            )
        )